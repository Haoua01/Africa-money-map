...
class DepartmentData(Shapefile):
    ...
    def compute_mean_scores(self, shp_department, area):
        ...
        if country == 'cameroun':
            output_path = f'/workspaces/Africa-money-map/data/results/scores/{area}_scores_departments_{country}.shp'
        else:
            output_path = f'/workspaces/Africa-money-map/data/results/scores/{area}_scores_departments.shp'
