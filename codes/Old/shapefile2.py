...
class Shapefile:
    ...
    def get_department_mapping(self, calculation_type):
        return self.get_scores_mapping('ADM2_FR', 'id', calculation_type)
    
    def get_region_mapping(self, calculation_type):
        return self.get_scores_mapping('ADM1_FR', 'id', calculation_type)
    
    def get_country_mapping(self, calculation_type):
        return self.get_scores_mapping('ADM0_FR', 'id', calculation_type)
