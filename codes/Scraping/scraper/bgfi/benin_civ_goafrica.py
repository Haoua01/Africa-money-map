...
country_code = {
    "benin": "https://www.goafricaonline.com/bj/9168-bgfi-bank-banques-cotonou-benin",
    "cotedivoire": "https://www.goafricaonline.com/ci/360911-bgfibank-banques-abidjan-cote-ivoire",
}
...
with open('/workspaces/Africa-money-map/codes/Scraping/UEMOA_v3/bgfi/benin_civ_goafrica_cleaned.json', 'w', encoding='utf-8') as json_file:  # Update with actual path
...
with open('bgfi/bgfi_corrected.json', 'r') as f:
...
with open('result/json_data_all/bgfi.json', 'w', encoding='utf-8') as f:
...
gdf.to_file('/Users/haouabenaliabbo/Desktop/M2 IREN/ALTERNANCE/GitHub/Scrapping-banks/bgfi/bgfi_geocoded2.shp')
"""