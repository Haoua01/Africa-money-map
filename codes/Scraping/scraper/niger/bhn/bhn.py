...
address_af = agency_city_dict = {
    "Agence principale": "Place Toumo, Avenue de l'OUA, Niamey, Niger",
    "Agence 2": "Niamey, Niamey, Niger",
    "Agence 3": "Niamey, Niamey, Niger",
...
with open("/Users/haouabenaliabbo/Desktop/M2 IREN/ALTERNANCE/GitHub/Scrapping-banks/niger/bhn/bhn.json", "w") as f:
    json.dump(data_all, f, indent=4)
"""
import json
with open("niger/bhn/bhn.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
with open("result/json_data_all/bhn.json", "w", encoding="utf-8") as f:
...
gdf.to_file('/Users/haouabenaliabbo/Desktop/M2 IREN/ALTERNANCE/GitHub/Scrapping-banks/niger/bhn/bhn_weak.shp')
