...
with open('/Users/haouabenaliabbo/Desktop/M2 IREN/ALTERNANCE/GitHub/Scrapping-banks/UEMOA/niger/bia/bia.json', 'w') as f:
    json.dump(country_data, f, indent=4)
"""
import json
# Read the JSON file
with open('niger/bia/bia.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
with open('result/json_data_all/bia_niger.json', 'w', encoding='utf-8') as f:
